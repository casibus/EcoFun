...
# A more elegant inline version: cats = [[int(random.rand()*size_),int(random.rand()*size_), -refreshingPeriodCats,0, random.rand()*max_age_c, 0, 0] for cat in cats]
# For a later lesson we should work object oriented!
